...
\usepackage[backend=biber,style=authoryear, mincitenames=1]{biblatex}
...
\input{comsology_dist.tex}
\newpage
\input{high_energy_part.tex}
\newpage
\input{Acc_probes.tex}
\newpage
\input{AGN.tex}
\newpage
\input{Compact symmetric objects.tex}
\newpage
\input{CSO.tex}
\newpage
